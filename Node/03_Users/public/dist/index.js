        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, axios.get('/api/user3')];
                case 1:
                    data = (_a.sent()).data;
                    users = data.users, error = data.error;
                    console.log(users);
...
function handleGetUser4() {
    return __awaiter(this, void 0, void 0, function () {
        var data, users, error, error_4;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 2, , 3]);
                    console.log('Get User 4 Clicked');
                    return [4 /*yield*/, axios.get('/api/user4')];
                case 1:
                    data = (_a.sent()).data;
                    users = data.users, error = data.error;
                    console.log(users);
...
function handleGetUser5() {
    return __awaiter(this, void 0, void 0, function () {
        var data, users, error, error_5;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 2, , 3]);
                    console.log('Get User 5 Clicked');
                    return [4 /*yield*/, axios.get('/api/user5')];
                case 1:
                    data = (_a.sent()).data;
                    users = data.users, error = data.error;
                    console.log(users);
...
function handleGetAllUsers() {
    return __awaiter(this, void 0, void 0, function () {
        var data, users, error, error_6;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 2, , 3]);
                    console.log('Get All Users Clicked');
                    return [4 /*yield*/, axios.get('/api/all-users')];
                case 1:
                    data = (_a.sent()).data;
                    console.log(data);
                    users = data.users, error = data.error;
