...
function handleActionGames() {
    return __awaiter(this, void 0, void 0, function () {
        var data, arrActionGames, error, error_1;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 2, , 3]);
                    return [4 /*yield*/, axios.get('/api/action-games')];
                case 1:
                    data = (_a.sent()).data;
                    arrActionGames = data.arrActionGames, error = data.error;
                    if (error)
...
function renderGames(arr) {
    var gameShowcase = document.querySelector('#gamesShowcase');
